...
# compile glbl module
$bin_path/vlogan $vlogan_opts   +define+$vlogan_define +v2k -sverilog -work xil_defaultlib -f ../cfg/dut_filelist.f -f ../cfg/filelist_hw_engine.f 2>&1 | tee -a vlogan.log
...
$bin_path/vlogan $vlogan_opts +define+$vlogan_define -sverilog -work xil_defaultlib +define+SVT_UVM_TECHNOLOGY \
	...
	-timescale=1ns/1ps \
    -f ../cfg/env_filelist.f  2>&1 | tee -a vlogan.log
